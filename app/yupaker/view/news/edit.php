...
<div class="page-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width:auto">
        	{volist name="$tagslist" id="vo" empty="暂时没有数据"}
            <input type="checkbox" class="field-tagids" name="tagids[]" value="{$vo.title}" title="{$vo.title}">
            {/volist}
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">封面图</label>
            <div class="layui-input-inline upload">
                ...
                {if condition="!empty($data_info['image'])"}
