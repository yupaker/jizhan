<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:53:"E:\gitlearn\yupaker/app/yupaker\view\orders\index.php";i:1530772351;s:47:"E:\gitlearn\yupaker\app\yupaker\view\layout.php";i:1530240845;s:51:"E:\gitlearn\yupaker\app\admin\view\block\header.php";i:1530240845;s:50:"E:\gitlearn\yupaker\app\admin\view\block\layui.php";i:1530240845;s:51:"E:\gitlearn\yupaker\app\admin\view\block\footer.php";i:1530240845;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        ...
        <a href="<?php echo url('status?table=yupaker_orders&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>进行中</a>
        <a href="<?php echo url('status?table=yupaker_orders&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>完成</a>
        <a href="<?php echo url('del?table=yupaker_orders'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="layui-btn-group">
                        <a href="<?php echo url('view?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small">查看</a>
                        <a data-href="<?php echo url('del?table=yupaker_orders&ids='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
