<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"E:\gitlearn\yupaker/app/yupaker\view\tags\index.php";i:1523951427;s:47:"E:\gitlearn\yupaker\app\yupaker\view\layout.php";i:1523842193;s:51:"E:\gitlearn\yupaker\app\admin\view\block\header.php";i:1523412544;s:50:"E:\gitlearn\yupaker\app\admin\view\block\layui.php";i:1523412544;s:51:"E:\gitlearn\yupaker\app\admin\view\block\footer.php";i:1523412544;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        ...
        <a href="<?php echo url('status?table=yupaker_tags&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-qiyong"></i>正常</a>
        <a href="<?php echo url('status?table=yupaker_tags&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns"><i class="aicon ai-jinyong1"></i>关闭</a>
        <a href="<?php echo url('del?table=yupaker_tags'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm"><i class="aicon ai-jinyong"></i>删除</a>
    </div>
</div>
    ...
    <table class="layui-table mt10" lay-even="" lay-skin="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $vo['newsnum']; ?></td>
                <td><input type="checkbox" name="status" <?php if($vo['status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" data-href="<?php echo url('status?table=yupaker_tags&ids='.$vo['id']); ?>"></td>
                <td>
                    <div class="layui-btn-group">
                        <a href="<?php echo url('edit?id='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                        <a data-href="<?php echo url('del?table=yupaker_tags&ids='.$vo['id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
                    </div>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
