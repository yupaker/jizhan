<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:35:"theme\yupaker\default\news\show.php";i:1526350326;s:57:"E:\gitlearn\hisiphp\theme\yupaker\default\public\head.php";i:1524129565;s:62:"E:\gitlearn\hisiphp\theme\yupaker\default\block\index_head.php";i:1523933072;s:62:"E:\gitlearn\hisiphp\theme\yupaker\default\block\avatar_box.php";i:1524129961;s:56:"E:\gitlearn\hisiphp\theme\yupaker\default\block\menu.php";i:1524037356;s:56:"E:\gitlearn\hisiphp\theme\yupaker\default\block\left.php";i:1524105406;s:57:"E:\gitlearn\hisiphp\theme\yupaker\default\public\foot.php";i:1523931524;}*/ ?>
                    ...
                    <dd>
                      <ul class="comments-list">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          ...
                          <div class="author-img"><img src="/theme/yupaker/default/static/image/avatar.png"></div>
                          <div class="comments-body">
                            <div class="comment-name">
                              <span class="arrow left"></span>
                              <cite class="fn"><?php echo $vo['nickname']; ?></cite><span class="right"><?php echo date('Y-m-d H:i:s', $vo['addtime']); ?> <a>回复</a></span>
                            </div>
                            <div class="comment-text">
                            <?php echo $vo['content']; ?>
                            </div>
                            <?php if($vo['childlist'] != Array()): ?>
                            <div class="recomment">
                              ...
                              <div class="recomlist"><blue><?php echo $vol['nickname']; ?></blue> 回复 <blue><?php echo $vol['rename']; ?></blue> ： <?php echo $vol['content']; ?>  <span><?php echo date('Y-m-d H:i:s', $vol['addtime']); ?> <a>回复</a></span></div>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                            <?php endif; ?>
                          </div>
